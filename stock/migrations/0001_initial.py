# Generated by Django 3.2.5 on 2023-10-16 13:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ifu', models.CharField(blank=True, max_length=255, null=True, unique=True)),
                ('rccm', models.CharField(blank=True, max_length=255, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_ttc', models.IntegerField()),
                ('net_a_payer', models.IntegerField()),
                ('etat_fact', models.BooleanField(default=False)),
                ('etat_pay', models.BooleanField(default=False)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stock.client')),
            ],
        ),
        migrations.AddField(
